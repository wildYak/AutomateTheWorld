...
public class DaxWalker {
    ...
    public static void walkToBeta(Positionable destination) {
        ...
        ArrayList<RSTile> path = TeleportManager.getquestItem(pathResult.getPathStatus() == PathStatus.SUCCESS ? pathResult.getCost() : Integer.MAX_VALUE, destination.getPosition());
